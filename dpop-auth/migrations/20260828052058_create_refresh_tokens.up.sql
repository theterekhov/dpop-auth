...
-- TABLE
CREATE TABLE IF NOT EXISTS dpop_refresh_tokens(
...
-- INDEXES
CREATE INDEX IF NOT EXISTS idx_dpop_rt_user
	ON dpop_refresh_tokens (user_id)
	WHERE revoked_at IS NULL;

CREATE INDEX IF NOT EXISTS idx_dpop_rt_fam
	ON dpop_refresh_tokens (fam);

CREATE INDEX IF NOT EXISTS idx_dpop_rt_expires
